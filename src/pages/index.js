...
import CollectionWebP from "../images/collections.webp"
  ...
  return (
    <Layout>
      ...
      <Section>
        <TextIndent>
          <SectionText>
            Existing social media platforms are poor at fostering communities
            and are sometimes outright exhausting for creators
          </SectionText>
        </TextIndent>
      </Section>
      ...
      <Step1>
        ...
        <Picture
          png={Step1PNG}
          webp={Step1WEBP}
          alt="An image of a social media feed and like buttons"
        />
      </Step1>
      ...
      <Step2>
        ...
        <div>
          ...
          <Text>
            We believe that creating art is all about connecting with others and
            what better way to do that than storytelling
          </Text>
        </div>
      </Step2>
      ...
      <Step3>
        <div>
          ...
          <Text>
            We support visual work, music, voice lines, songs, poems, stories,
            and more!
          </Text>
        </div>
      ...
      <Step4>
        <Picture
          png={Step4PNG}
          webp={Step4WEBP}
          alt="A painting with music being added to it"
        />
        <div>
          <SectionHeader>Watch others collaborate with you</SectionHeader>
          <Text>
            Anyone can seamlessly pair their work with yours, on the fly, an
            unlimited number of times. Usually collaboration requires a lot of
            planning, but not here.
          </Text>
        </div>
      </Step4>
      ...
      <Step5>
        ...
        <Picture
          png={Step5PNG}
          webp={Step5WEBP}
          alt="A collaboration with writing being added to it"
        />
      </Step5>
      ...
      <Step6>
        <Picture
          png={Step6PNG}
          webp={Step6WEBP}
          alt="A complete collaboration of art"
        />
        <div>
          <SectionHeader>Rejoice in the experiences you create</SectionHeader>
          <Text>
            It creates an emotional experience that connects with you, your
            peers, and others
          </Text>
        </div>
      </Step6>
      ...
      <Section>
        <TextIndent>
          <SectionText>
            ...
            warm, cozy place to jam with other creators and meet new friends
            online. Tell the stories that are currently just in your imagination
            and we'll work on sharing your work with as many people as possible!
          </SectionText>
        </TextIndent>
      </Section>
      ...
      <Showcase>
        <Picture
          png={ShowcasePNG}
          webp={ShowcaseWEBP}
          alt="A showcase of collaborations"
        />
      </Showcase>

      <Cta
        header="Sign up for updates"
        subHeader="Stay up to date with everything that we are doing"
      />

      <Section>
        <TextIndent>
          <SectionHeader>
            Not convinced it's for you? Hear what our users have to say
          </SectionHeader>
          <Text>
            Collaborating with complete strangers is always an act of trust, and
            this platform gave me the confidence to share my work freely without
            fear of losing attribution. And then when I got to read the
            delighted comments by artists for whom sharing work was usually a
          ...
          <Testimonial>
            <Picture
              png={CharraPNG}
              webp={CharraWEBP}
              alt="Charra's profile picture"
            />
          </Testimonial>
          <Text>
            As an illustrator, I never knew that I was missing the opportunity
            to easily collaborate with musicians and writers. It's an amazing
            feeling to bring your creations more depth with the help of others
            and to explore more of your own creativity through the language of
            other great artists. On top of that, it's a great way to make
          ...
          <Testimonial>
            <Picture
              png={FederfarbePNG}
              webp={FederfarbeWEBP}
              alt="Federfarbe's profile picture"
            />
          </Testimonial>
        </TextIndent>
      </Section>
      ...
      <Section>
        <TextIndent>
          <SectionText>
            To tie it altogether, we also offer the ability to create
            collections, which empower artists to collaborate on entire worlds
            together.
          </SectionText>
        </TextIndent>
      </Section>
      ...
      <Showcase>
        <Picture webp={CollectionWebP} alt="A showcase of art on Bard" />
      </Showcase>
      ...
      <Section>
        <TextIndent>
          <SectionText>
            And if you need some final convincing, here's a list of everything
            we offer
          </SectionText>
        </TextIndent>
      </Section>
